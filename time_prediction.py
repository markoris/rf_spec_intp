...
intp.load_data('/lustre/scratch4/turquoise/mristic/knsc1_active_learning/*spec*', '/lustre/scratch4/turquoise/mristic/h5_data/TP_wind2_spectra.h5', t_max=float(time.replace("p", ".")), theta=None, trim_dataset=True)
intp.create_test_set(size=5)
intp.append_input_parameter(intp.angles, 2)
intp.preprocess()
intp.load('/lustre/scratch4/turquoise/mristic/rf_spec_intp_optim_trimdata_time%sdays.joblib' % time)
